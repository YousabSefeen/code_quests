...
class GenderDropdownField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        BlocSelector<AppointmentCubit, AppointmentState, int?>(
          selector: (state) => state.selectedGenderIndex,
          builder: (context, selectedGenderIndex) => AnimatedDropDownFormField(
            ...
            onChangeSelectedIndex: (int index) => context
  ...
  String _getDisplayText(int? selectedGenderIndex) {
    String displayText = '';
  ...
  TextStyle _getTextStyle(int? selectedGenderIndex, TextTheme textTheme) {

...
import 'package:flutter_task/features/appointments/presentation/widgets/time_slots_loader_section.dart';
...
class AppointmentTimeSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocSelector<AppointmentCubit, AppointmentState, AppointmentAvailabilityStatus>(

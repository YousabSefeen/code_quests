...
import 'package:flutter_task/features/appointments/presentation/widgets/time_slots_display_section.dart';
...
class TimeSlotsLoaderSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocSelector<AppointmentCubit, AppointmentState, Tuple2<RequestState, String>>(
      selector: (state) => Tuple2(state.reservedTimeSlotsState, state.reservedTimeSlotsError),
